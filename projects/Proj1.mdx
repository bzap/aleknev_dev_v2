...
<Center
    py={'1em'}
    gap={{base: '0em', sm: '2em', md:'4em', lg: '0em'}}>
        <Flex> 
            ![The home screen.](/screenshots/go1.webp_600_1068)
        </Flex> 
        <Flex>
            ![The assessment screen.](/screenshots/go2.webp_600_1068)
        </Flex>
</Center>
<br/>
<br/>
...
<Center
    py={'1em'}
    position={'relative'}
    gap={{base: '2em', sm: '2em', md:'4em', lg: '0em'}}
    direction={'row'}>
            <Center>
                ![The previous results screen.](/screenshots/go3.webp_600_1078)
            </Center>
            <Center>
                ![The graph screen.](/screenshots/go4.webp_600_840)
            </Center>
</Center>
<br/>
<br/>
