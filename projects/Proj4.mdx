...
<Center
    ...
    direction={'row'}>
        <Center>
            ![The home screen.](/screenshots/rest2.webp_1040_1482)
        </Center>
        <Center>
            ![The submission screen.](/screenshots/rest1.webp_1290_1486)
        </Center>
</Center>
<br/>
<br/>
...
<Center
    ...
    direction={'row'}>
        <Center>
            ![The registration form.](/screenshots/rest3.webp_1412_1162)
        </Center>
</Center>
<br/>
<Center
    ...
    direction={'column'}>
        <Center>
            ![The user reviews.](/screenshots/rest4.webp_1730_1724)
        </Center>
</Center>
<br/>
<br/>
...
<Center
    ...
    direction={'row'}>
        <Center>
            ![The home screen.](/screenshots/rest5.webp_1238_1266)
        </Center>
</Center>
<br/>